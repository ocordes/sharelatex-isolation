/* logfile.c
   ...
   updated: Oliver Cordes 2025-07-04
...
void logfile_init(void)
{
  ...
  {
    if (shareiso_trunc_logfile == 1)
	    logging_logfile = orig_fopen(shareiso_logging_name, "w+");
    else
	    logging_logfile = orig_fopen(shareiso_logging_name, "a+");
